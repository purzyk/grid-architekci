	...
	acf_add_local_field_group( array(
		...
		'fields' => array(
			...
			array(
				...
				'type'  => 'group',
				'sub_fields' => array(
					array( 'key' => 'field_m_klient', 'label' => 'Klient', 'name' => 'klient', 'type' => 'text' ),
					array( 'key' => 'field_m_zakres', 'label' => 'Zakres', 'name' => 'zakres', 'type' => 'text' ),
					array( 'key' => 'field_m_zespol', 'label' => 'Zespół', 'name' => 'zespol', 'type' => 'text' ),
					array( 'key' => 'field_m_konstrukcja', 'label' => 'Konstrukcja', 'name' => 'konstrukcja', 'type' => 'text' ),
					array( 'key' => 'field_m_instalacje', 'label' => 'Instalacje', 'name' => 'instalacje', 'type' => 'text' ),
					array( 'key' => 'field_m_wykonawca', 'label' => 'Wykonawca', 'name' => 'wykonawca', 'type' => 'text' ),
					array( 'key' => 'field_m_autor_zdjec', 'label' => 'Autor zdjęć', 'name' => 'autor_zdjec', 'type' => 'text' ),
				),
			),
		),
		'location' => array(
