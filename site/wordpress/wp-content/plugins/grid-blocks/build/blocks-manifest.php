...
return array(
	...
	'cookie-consent' => array(
		'$schema' => 'https://schemas.wp.org/trunk/block.json',
		'apiVersion' => 3,
		'name' => 'grid/cookie-consent',
		'title' => 'Banner cookies',
		'category' => 'grid-blocks',
		'icon' => 'privacy',
		'description' => 'Stały pasek na dole strony — RODO/PKE zgoda na Google Analytics. Wybór klienta trafia do cookie grid_consent, odczytywanego w przeglądarce (nie w PHP — strona jest cache\'owana przez WP Super Cache, więc zgodę trzeba sprawdzać po stronie klienta). Niewidoczny w edytorze (nakładka na cały front, nie sensowna jako podgląd inline).',
		'supports' => array(
			'html' => false,
			'multiple' => false
		),
	...
	'not-found' => array(
		...
		'category' => 'grid-blocks',
		'icon' => 'warning',
		'description' => 'Kicker, nagłówek, opis i link powrotny na stronie 404. Dynamiczny render.php zamiast statycznej treści w 404.html, żeby WPML String Translation mogło objąć te stringi.',
		'supports' => array(
			'html' => false,
			'multiple' => false
		),
	...
	'site-footer-info' => array(
		'$schema' => 'https://schemas.wp.org/trunk/block.json',
		'apiVersion' => 3,
		'name' => 'grid/site-footer-info',
		'title' => 'Stopka — informacje',
		'category' => 'grid-blocks',
		'icon' => 'info',
		'description' => 'Dolna część stopki: social linki, notka, adres, copyright i link do polityki prywatności. Dynamiczny render.php zamiast statycznej treści w footer.html, żeby tłumaczalne stringi dało się objąć WPML String Translation (adres/nazwy social/domena zostają zwykłym tekstem — to nie są rzeczy do tłumaczenia).',
		'supports' => array(
			'html' => false,
			'multiple' => false
		),
